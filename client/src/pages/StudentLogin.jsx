...
import { PiEnvelopeSimple, PiLockSimple, PiEye, PiEyeClosed, PiStudent, PiArrowLeft, PiGoogleLogo } from 'react-icons/pi';

// Reusing the styles from the landing page for consistency, with additions for the form
const pageStyles = `
  .bg-image {
                ...
                <div className="relative z-10 w-full max-w-md animate-slide-up">
                    <div className="border border-white/10 bg-slate-800/50 backdrop-blur-lg rounded-2xl shadow-xl p-8 sm:p-12">
                        ...
                        <form onSubmit={handleSubmit} noValidate className="space-y-6">
                            ...
                            <div className="floating-label-group">
                                ...
                                <input
                                    ...
                                    className="peer w-full pl-12 pr-4 py-3 bg-white/5 text-white rounded-lg border-2 border-transparent focus:border-teal-400/50 focus:bg-white/10 focus:ring-0 transition-all placeholder:text-transparent"
                            ...
                            <div className="floating-label-group">
                                ...
                                <input
                                    ...
                                    className="peer w-full pl-12 pr-12 py-3 bg-white/5 text-white rounded-lg border-2 border-transparent focus:border-teal-400/50 focus:bg-white/10 focus:ring-0 transition-all placeholder:text-transparent"
                        ...
                        <p className="text-center text-sm text-gray-400 mt-8">
                            ...
                            <Link to="/signup/student" className="font-medium text-teal-300 hover:underline">
                                Sign up
                            </Link>
                        </p>
                    </div>
