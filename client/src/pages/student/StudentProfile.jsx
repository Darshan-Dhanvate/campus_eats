    ...
    return (
        <div>
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8">
                ...
                <button className="bg-brand-dark-blue text-white font-bold py-2 px-6 rounded-lg hover:bg-slate-700 transition duration-300">
                    Edit Profile
                </button>
            </div>
                ...
                <div className="bg-white p-6 rounded-lg shadow-sm">
                    ...
                    <div className="space-y-4">
                       ...
                       <div className="flex justify-between items-center">
                           ...
                           <button className="text-sm text-brand-green font-semibold">Update</button>
                       </div>
                    </div>
                </div>
            </div>
